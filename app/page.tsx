        ...
        <header className="text-center mb-12">
          ...
          <div className="bg-zinc-800 text-white p-5 rounded-lg shadow-lg max-w-xl mx-auto">
            <p className="text-base leading-relaxed">
              <span className="text-green-400 font-medium">人気度</span>はSpotifyの内部指標です。再生回数・リスナー数・成長速度などから算出され、<span className="text-green-400 font-medium">0〜100の数値</span>で表されます。
            </p>
          </div>
        </header>
