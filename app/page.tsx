...
export default function Home() {
  ...
  return (
    <main className="min-h-screen bg-black text-white py-10 px-4 font-sans flex flex-col">
      ...
      <div className="text-center text-xs py-4 space-y-1">
        <div className="flex items-center justify-center gap-1.5 text-zinc-600">
          ...
          <span>Powered by Spotify API · Created by <a href="https://x.com/sbsysil" target="_blank" rel="noopener noreferrer" className="hover:text-zinc-400 transition-colors">YANCE</a></span>
        </div>
        <a
