      ...
      <body className="min-h-screen bg-black text-white antialiased font-display">
        ...
        <footer className="text-center text-zinc-600 text-xs py-2 px-4 space-y-0.5">
          <div className="flex items-center justify-center gap-1.5 flex-wrap">
            ...
            <span>Powered by Spotify API · Not affiliated with Spotify · Created by YANCE</span>
          </div>
          <a href="https://buymeacoffee.com/yance" target="_blank" rel="noopener noreferrer" className="text-zinc-700 hover:text-zinc-400 transition-colors">Buy Me a Coffee</a>
        </footer>
        <Analytics />
      </body>
    </html>
